...
<html >
  ...
  <div class="mask">
      <div class="c">
          <div style="background-color: darksalmon;height:30px;color: #173e65;font-size: 14px;padding-left: 9px;">
            修改信息
            <font style="float: right;padding-right: 10px;" onclick="cancelEdit()">X</font>
          </div>
          <form id="editForm" action="edit.action" method="post">
              姓名：<input type="text" id="editName" name="name" style="width: 120px"/>
              <br/>
              手机：<input type="text" id="editTelphone" name="telephone" style="width: 120px"/>
              <br/>
              地址：<input type="text" id="editAddress" name="address" style="width: 120px"/>
              <br/>
              ...
              <input type="submit" value="提交" style="background-color: orange;color: #cccccc;width: 70px"/>
          </form>
      </div>
  </div>
